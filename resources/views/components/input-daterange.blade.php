...
<label class="relative block w-full max-w-xs">
    ...
    <input
        {{ $attributes->class([
            'input input-bordered input-xs font-sans cursor-pointer font-semibold placeholder:italic placeholder:text-slate-400 block w-full border border-slate-300 pl-6 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-xs',
        ]) }}
