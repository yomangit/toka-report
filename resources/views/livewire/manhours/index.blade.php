        ...
        <div class=" justify-self-start">
            <div class="flex gap-1">
                ...
                <div class="@if ($bulkDisable) hidden  @endif ">
                    ...
                    <x-icon-btn-delete class="tooltip-right" data-tip="Delete Selected" wire:confirm.prompt="Are you sure you want to delete selected data ?\n\nType DELETE to confirm|DELETE" wire:click="deleteAll"></x-icon-btn-delete>
                </div>
                @endif
            </div>
        ...
        <table class="table table-xs table-pin-cols table-pin-rows ">
            ...
            <thead>
                <tr class="text-center">
                    ...
                    @if ($show)
                    <th>
                        <input type="checkbox" wire:model.live="selectAll" class="checkbox checkbox-xs [--chkbg:oklch(var(--a))] [--chkfg:oklch(var(--p))]" />
                    </th>
                    @endif
                    <th>Date</th>
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    @if ($show)
                    <th>
                        <input value="{{ $cc->id }}" type="checkbox" wire:model.live="seleted_manhours" class="checkbox checkbox-xs [--chkbg:oklch(var(--in))] [--chkfg:oklch(var(--a))]" />
                    </th>
                    @endif
                    ...
                    <td>
                        <div class="">
                            <x-icon-btn-edit wire:click="$dispatch('openModalManhours',{ id: {{ $cc->id }} })" data-tip="Update"></x-icon-btn-edit>
                            <x-icon-btn-delete wire:click="delete({{ $cc->id }})" wire:confirm.prompt="Are you sure you want to delete this data ?\n\nType DELETE to confirm|DELETE" data-tip="Delete"></x-icon-btn-delete>
                        </div>
                    </td>
                    @endif
                </tr>
