<div class="p-2 md:p-4">
    <form wire:submit.prevent='store'>
        ...
        <div wire:target="store" wire:loading.class="skeleton" class="flex items-center p-3 bg-white border rounded-md shadow-sm">
        ...
        <x-modal wire:model="showHistoryModal" maxWidth="2xl">
            <x-slot name="title">
                📜 Riwayat Perubahan
                 ...
                 <div class="max-h-[70vh] overflow-y-scroll pr-2">
