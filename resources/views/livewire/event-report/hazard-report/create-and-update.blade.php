                    ...
                    <div class="card-body ">
                        ...
                        <div class="grid items-end grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <fieldset class="relative fieldset md:col-span-1">
                                ...
                                <div class="relative">
                                    <input name="searchActResponsibility" type="text" wire:model.live.debounce.300ms="searchActResponsibility" placeholder="Cari Penanggung Jawab..." class="input input-bordered w-full focus:ring-1 focus:border-info focus:ring-info focus:outline-hidden input-xs {{ $errors->has('pelapor_id') ? 'ring-1 ring-rose-500 focus:ring-rose-500 focus:border-rose-500' : '' }}" />
