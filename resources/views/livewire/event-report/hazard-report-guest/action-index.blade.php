<div>
    ...
    <div class="flex flex-col items-center justify-between p-2 mb-2 border border-b-2 rounded-md sm:flex-row border-base-300">
        ...
        <div class="w-full p-4 basis-3/4">
            <div class="flex flex-col items-stretch divide-y divide-gray-400 ">
                ...
                <div class="grid flex-row grid-cols-4 gap-1 text-gray-500 ">
                    ...
                    <span class="font-mono text-[10px] text-justify font-semibold col-span-3">{{ $data['followup_action'] }}</span>
                </div>
                <div class="grid flex-row grid-cols-4 gap-1 text-gray-500 ">
