<div>
    <div>
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="w-full max-w-md xl:max-w-xl form-control">
                    <fieldset class="fieldset ">
                        ...
                        <div class="relative">
                            <!-- Input Search -->
                            <x-input wire:model.live='searchPelapor' wire:keydown.self="changeConditionDivision" placeholder='pilih marga atau nama...' :error="$errors->get('pelapor_id')" class="cursor-pointer" />
        ...
        <script>
            ...
            Livewire.on('resetCkEditorAction', event => {
                if (ckAction_description) {
