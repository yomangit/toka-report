            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="flex flex-row justify-center gap-1">
                        ...
                        <x-icon-btn-delete wire:click="delete({{ $item->id }})" wire:confirm.prompt="Are you sure delete {{ $item->route_name }}?\n\nType DELETE to confirm|DELETE" data-tip="Delete" />
                    </td>
                </tr>
                @empty
                <tr>
                    <th colspan="3" class="text-center text-error">data not found!!! </th>
                </tr>
                @endforelse
