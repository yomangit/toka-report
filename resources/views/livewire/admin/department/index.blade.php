            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="flex flex-row justify-center gap-1">
                        <x-icon-btn-edit data-tip="Edit" wire:click="$dispatch('openModal', { component: 'admin.department.create-and-update', arguments: { dept: {{ $dept->id }} }})" />
                        <x-icon-btn-delete wire:click="delete({{ $dept->id }})" wire:confirm.prompt="Are you sure delete {{ $dept->department_name }}?\n\nType DELETE to confirm|DELETE" data-tip="Delete" />
                    </td>
