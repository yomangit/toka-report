            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="flex flex-row justify-center gap-1">
                        <x-icon-btn-edit data-tip="Edit" wire:click="$dispatch('openModal', { component: 'admin.company.create-and-update', arguments: { company: {{ $cc->id }} }})" />
                        <x-icon-btn-delete wire:click="delete({{ $cc->id }})" wire:confirm.prompt="Are you sure delete {{ $cc->name_company }}?\n\nType DELETE to confirm|DELETE" data-tip="Delete" />
                    </td>
                </tr>
                @empty
                <tr class="text-center">
