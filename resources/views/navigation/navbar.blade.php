<div class="sticky top-0 left-0 z-50 flex items-center px-2 shadow-md bg-base-300 shadow-black/5">
    ...
    <button type="button" class="py-3 text-lg text-gray-600 sidebar-toggle">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.75A.75.75 0 0 1 2.75 3h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 3.75ZM2 8a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 8Zm0 4.25a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Z" />
        </svg>
    </button>
    ...
    <div class="flex items-center gap-1 ml-auto">
        ...
        <div class="dropdown dropdown-bottom dropdown-end">
            <div tabindex="0" role="button">
                <p class="capitalize text-xs font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#03346E] to-[#021526]">
                    {{ auth()->user()->lookup_name ?? 'guest' }}
                </p>
            </div>
            ...
            <ul tabindex="0" class="dropdown-content menu menu-xs bg-base-300 rounded-box z-[1] w-52 shadow">
                <li>
                    <a href="{{ route('locale', 'en') }}">
                        <x-flag-language-en class="w-4 h-4" /> English
                    </a>
                </li>
                <li>
                    <a href="{{ route('locale', 'id') }}">
                        <x-flag-language-id class="w-4 h-4" /> Indonesia
                    </a>
                </li>
            </ul>
        </div>
